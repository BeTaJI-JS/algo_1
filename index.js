...
const obj = new ObjectArray(friends)
const obj_2 = new ObjectArray(posts)
console.log(obj.group("first_name"))
// console.log(obj_2.filter("id",3))
// console.log(obj_2.filter("userId",3))
console.log(obj.sort("id"))
console.log(obj.aggretate("first_name", "count"))
console.log(obj.sort("first_name","count"))
console.log(obj.aggretate("first_name", "count"))
console.log(obj.aggretate("first_name", "max"))
console.log(obj.aggretate("first_name", "min"))
console.log(obj.aggretate("first_name", "sum"))
console.log(obj.aggretate("first_name", "avg"))
console.log(obj.aggretate("last_name", "avg"))
console.log(obj.aggretate("id", "avg"))